...
public class EventSimilarityHandler {
    ...
    public void handle(EventSimilarityAvro eventSimilarityAvro) {
        log.debug(
                "Processing EventSimilarityAvro: eventA={}, eventB={}, score={}",
        ...
        if (eventSimilarityOpt.isEmpty()) {
            log.info(
                    "Creating new event similarity record: eventA={}, eventB={}, score={}",
                    eventIdA,
                    eventIdB,
                    eventSimilarityAvro.getScore());
            ...
            log.debug(
                    "Updating existing event similarity record: eventA={}, eventB={}, oldScore={},"
                            + " newScore={}",
                    eventIdA,
                    eventIdB,
    ...
    private void createEventSimilarity(
        ...
        log.info(
                "Event similarity created successfully: id={}, eventA={}, eventB={}, score={}",
                saved.getId(),
                eventIdA,
                eventIdB,
                eventSimilarityAvro.getScore());
    ...
    private void updateEventSimilarity(
        ...
        log.debug(
                "Event similarity updated successfully: id={}, eventA={}, eventB={}, newScore={}",
                updated.getId(),
